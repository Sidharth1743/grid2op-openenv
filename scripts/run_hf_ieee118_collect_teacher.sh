...
export HF_USERNAME BRANCH_NAME HF_JOB_FLAVOR GRID2OP_ENV_NAME TEACHER_MODEL TEACHER_PORT TEACHER_MAX_MODEL_LEN TEACHER_GPU_MEMORY_UTILIZATION OUTPUT_PATH TASK_IDS EPISODES_PER_TASK MAX_STEPS_PER_EPISODE SEED_START MAX_TOKENS TEMPERATURE REMOTE_CMD
