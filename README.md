...
- Main benchmark comparison: [benchmark_task_scores.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/benchmark_task_scores.png)
- Seen vs unseen seeds: [generalization_seen_vs_unseen.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/generalization_seen_vs_unseen.png)
- Safety / failures: [safety_failures.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/safety_failures.png)
- Focused multistage GRPO plot: [multistage_dapo_focus.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/multistage_dapo_focus.png)
- Project-level tradeoff view: [performance_vs_effort.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/performance_vs_effort.png)
- Plot notes: [plots.md](/home/sidharth/Desktop/grid2op-openenv/hack/plots.md)

### Training Plot Exports

The repository also includes exported training curves under [training_plots](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots):

- [sft_train_loss.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots/sft_train_loss.png)
- [sft_eval_loss.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots/sft_eval_loss.png)
- [sft_train_entropy.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots/sft_train_entropy.png)
- [sft_eval_entropy.png](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots/sft_eval_entropy.png)

These are the committed image artifacts that back the SFT training story in addition to the W&B workspace.

Relevant benchmark and GRPO figures are also committed under [hack/assets](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets).
...
- committed plot exports: [training_plots](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots)
- committed benchmark and GRPO figures: [hack/assets](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets)

Key exported plots:

![SFT Train Loss](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots/sft_train_loss.png)

![SFT Eval Loss](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/training_plots/sft_eval_loss.png)

![Benchmark Task Scores](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/benchmark_task_scores.png)

![Focused Multistage GRPO Comparison](https://github.com/Sidharth1743/grid2op-openenv/tree/hack-submission-clean/hack/assets/multistage_dapo_focus.png)
